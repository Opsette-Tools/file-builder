...
export default function PrivacyModal({ open, onClose }: PrivacyModalProps) {
  return (
    <Modal open={open} onCancel={onClose} footer={null} title="Privacy">
      ...
      <Paragraph>
        File Builder runs entirely in your browser. The files you add, the kit
        you assemble, and everything you compress or convert stay in your tab
        while you work. Nothing is uploaded to a server.
      </Paragraph>
      <Paragraph>
